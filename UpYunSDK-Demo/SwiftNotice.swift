...
extension UIViewController {
    ...
    func noticeOnlyText(text: String, autoClear: Bool, autoClearTime: Int = 3) {
...
class SwiftNotice: NSObject {
    ...
    static func showText(text: String, autoClear: Bool, autoClearTime: Int) {
        let window = UIWindow()
        window.backgroundColor = UIColor.clearColor()
        let mainView = UIView()
        mainView.layer.cornerRadius = 12
...
class SwiftNoticeSDK {
    ...
    class func draw(type: NoticeType) {
        ...
        checkmarkShapePath.addArcWithCenter(CGPointMake(18, 18), radius: 17.5,
        ...
        case .info:
            ...
            checkmarkShapePath.addArcWithCenter(CGPointMake(18, 27), radius: 1,
                startAngle: 0, endAngle: CGFloat(M_PI*2), clockwise: true)
            checkmarkShapePath.closePath()
